...
Satisfying our second software constraint, the human hits 'Sign & Broadcast'. The agent instantly unblocks the thread, connects to Viem via Base L2, and generates an EIP-712 cryptographic signature bounded by Auth0! 
